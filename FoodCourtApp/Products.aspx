...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row main-content">
        <div style="text-align: right;width:1000px;">
            <a style="font-weight:bold;cursor:pointer;" href="NewProduct.aspx">New Product</a>
        </div>
        <div id="divProductGrid" runat="server" class="row" align="center">
            <asp:GridView ID="grdProducts" CssClass="grd" Width="900px" runat="server" AutoGenerateColumns="False"
                AllowPaging="True"
